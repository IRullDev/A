...
/*============== UMUM ==============*/
global.namabot = "ichigyou" // nama bot 
global.namaowner = "iky" // nama owner
global.owner = ['6282275403263'] // nomor owner 
global.packname = 'Nomor Bot : 082250231163' // wm sticker yang diawal 
global.author = 'Sticker By iky' // wm sticker yang di akhir
global.fakelink = 'https://chat.whatsapp.com/HjvNhA5PfSS0sJ4ejnLDWp' //link grup
global.grubbot = 'https://chat.whatsapp.com/HjvNhA5PfSS0sJ4ejnLDWp' // link grup 
/*============== END ==============*/
...
/*============== SIMBOL ==============*/
global.simbol = (`≼≽`) // simbol awal list
global.simboll = (`🚩`) // simbol awal teks respon
/*============== END ==============*/
...
global.ahah = (`😭`) // pas ketik !out
global.modepublic = (`👥`) // autobio 
global.modeowner = (`📝`) // autobio ~ jangan di ubah
global.modeaktif = (`🕛`) // autobio 
global.emoji = (`☺️+😑`) 
global.hai = (`👋🏻`)
global.reactt = (`🗿`)
global.simbolll = (`🔍`) // simbol react wait
global.simbollll = (`✅`) // simbol react done
